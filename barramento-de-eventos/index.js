...
app.post('/eventos', async (req, res) => {
  ...
  try{
    ...
    await axios.post('http://192.168.56.1:4000/eventos', evento)
  }
  catch(e){
  ...
  try{
    ...
    await axios.post('http://192.168.56.1:5000/eventos', evento);
  }
  catch(e){
  ...
  try{
    ...
    await axios.post('http://192.168.56.1:6000/eventos', evento)
  }
  catch(e){
  ...
  try{
    ...
    await axios.post('http://192.168.56.1:7000/eventos', evento)
  }
  catch(e){
